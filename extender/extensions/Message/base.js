const { escapeMarkdown, splitMessage, resolveString } = require('../../../src/util');
const { oneLine } = require('common-tags');
const Command = require('../../../src/commands/base');
const FriendlyError = require('../../../src/errors/friendly');
const CommandFormatError = require('../../../src/errors/command-format');

module.exports = Eris => {


    Object.defineProperty(Eris.Message.prototype, "client", {
		get: function() {
     ...
     * @private
     */
    Eris.Message.prototype.initCommand = function (command, argString, patternMatches) {
        this.isCommand = true;
     ...
     * @return {string}
     */
    Eris.Message.prototype.usage = function (argString, prefix, user = this.client.user) {
     ...
     * @return {string}
     */
    Eris.Message.prototype.anyUsage = function (command, prefix, user = this.client.user) {
        if (typeof prefix === 'undefined') {
            if (this.guild) prefix = this.guild.commandPrefix;
            else prefix = this.client.commandPrefix;
        }
     ...
     */
    Eris.Message.prototype.parseArgs = function () {
     ...
     */
    Eris.Message.prototype.run = async function () { // eslint-disable-line complexity
        ...
        try {
            ...
            if (!(retVal instanceof Eris.Message || retVal instanceof Array || retVal === null || retVal === undefined)) {
     ...
     * @private
     */
    Eris.Message.prototype.respond = function ({ type = 'reply', content, options, lang, fromEdit = false }) {
     ...
     * @private
     */
    Eris.Message.prototype.editResponse = function (response, { type, content, options }) {
     ...
     * @private
     */
    Eris.Message.prototype.editCurrentResponse = function (id, options) {
     ...
     * @return {Promise<Message|Message[]>}
     */
    Eris.Message.prototype.say = function (content, options) {
     ...
     * @return {Promise<Message|Message[]>}
     */
    Eris.Message.prototype.reply = function (content, options) {
        if (!options && typeof content === 'object' && !(content instanceof Array)) {
            options = content;
            content = '';
        }
     ...
     * @return {Promise<Message|Message[]>}
     */
    Eris.Message.prototype.direct = function (content, options) {
        if (!options && typeof content === 'object' && !(content instanceof Array)) {
            options = content;
            content = '';
        }
     ...
     * @return {Promise<Message|Message[]>}
     */
    Eris.Message.prototype.code = function (lang, content, options) {
        if (!options && typeof content === 'object' && !(content instanceof Array)) {
            options = content;
            content = '';
        }
     ...
     * @return {Promise<Message|Message[]>}
     */
    Eris.Message.prototype.embed = function (embed, content = '', options) {
        if (typeof options !== 'object') options = {};
        options.embed = embed;
        return this.respond({ type: 'plain', content, options });
    }
     ...
     * @return {Promise<Message|Message[]>}
     */
    Eris.Message.prototype.replyEmbed = function (embed, content = '', options) {
        if (typeof options !== 'object') options = {};
        options.embed = embed;
        return this.respond({ type: 'reply', content, options });
    }
     ...
     * @private
     */
    Eris.Message.prototype.finalize = function (responses) {
     ...
     * @private
     */
    Eris.Message.prototype.deleteRemainingResponses = function () {
