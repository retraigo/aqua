...
class Argument {
	 ...
	 * {@link AquaRegistry#registerDefaultTypes} for the built-in types)
	...
	/**
	 * Either a value or a function that returns a value. The function is passed the Message and the Argument.
	 * @typedef {*|Function} ArgumentDefault
	 */

	/**
	 * @param {AquaClient} client - Client the argument is for
	 ...
	 * @param {AquaClient} client - Client to use the registry of
