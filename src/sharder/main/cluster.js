...
const SyncedRequestHandler = require('../classes/SyncedRequestHandler.js');
const { inspect } = require('util');
const IPC = require("../classes/IPC.js");
...
class Cluster {
            ...
            if (msg.name) {
                switch (msg.name) {
                    case "connect": {
                        ...
                        this.connect(msg.firstShardID, msg.lastShardID, this.maxShards, msg.token, "connect", msg.clientOptions, msg.aquaOptions);
     ...
     * @param {AquaClientOptions} aquaOptions
     * @memberof Cluster
     */
    connect(firstShardID, lastShardID, maxShards, token, type, clientOptions, aquaOptions) {
        ...
        const bot = new Client(token, options, aquaOptions);
        this.bot = bot;
